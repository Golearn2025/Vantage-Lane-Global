-- Seed additional network services + allow Quick Add to choose service_code.

insert into public.service_types (code, name, is_active)
values
  ('SECURITY', 'Security', true),
  ('PRIVATE_AVIATION', 'Private Aviation', true)
